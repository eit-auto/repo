 ...
 * @param {string} format - Luxon format string used to parse (default: 'yyyy-MM-dd HH:mm:ss')
 * @returns {string} Parsed datetime as ISO string
 */
function parse_datetime(value, format = 'yyyy-MM-dd HH:mm:ss') {
  try {
 ...
 * @param {string} tz - Timezone name (e.g., 'America/Denver', 'UTC', 'Europe/London')
 * @param {string} format - Optional Luxon format string (e.g., 'yyyy-MM-dd HH:mm:ss')
 * @returns {string} Current datetime as ISO string or formatted string
 */
